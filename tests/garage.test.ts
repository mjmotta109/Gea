...
describe('garaje: loadouts al desplegar', () => {
  ...
  it('sustituir un módulo cambia stats y maxHp derivado', () => {
    // La mochila del Liger (8 hp, evade+5) se cambia por el generador de
    // pantalla del garaje (16 hp, energyDef+6): gana casco y escudo, pierde
    // evasión. El maxHp DERIVA de lo montado, no del chasis.
    const stock = garage();
